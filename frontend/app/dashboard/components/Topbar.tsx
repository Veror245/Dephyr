...
export default function Topbar({ onOpenSidebar }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 w-full bg-[#08080a]/90 backdrop-blur-md border-b border-white/[0.08] px-6 sm:px-8 lg:px-10 flex items-center justify-between gap-4">
